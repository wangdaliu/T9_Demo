...
import com.t9.util.NameToNumber;
import com.t9.util.NameToNumberFactory;
...
public class T9SearchCache implements ComponentCallbacks2 {
    ...
    private static final Comparator<ContactItem> sNameComparator = new Comparator<ContactItem>() {
        ...
        public int compare(ContactItem lhs, ContactItem rhs) {
            ...
            if (lhs.timesContacted != rhs.timesContacted) {
                return -compareInt(lhs.timesContacted, rhs.timesContacted);
            }
            ...
            return compareInt(lowestMatchLeft, lowestMatchRight);
        }
    };
    ...
    private static final Comparator<ContactItem> sNumberComparator = new Comparator<ContactItem>() {
        ...
        public int compare(ContactItem lhs, ContactItem rhs) {
            ...
            int ret = -compareInt(rhs.timesContacted, lhs.timesContacted);
            if (ret == 0) ret = compareBool(rhs.isSuperPrimary, lhs.isSuperPrimary);
            if (ret == 0) ret = compareInt(lhs.numberMatchId, rhs.numberMatchId);
            return ret;
        }
    };
    ...
    public class T9Adapter extends ArrayAdapter<ContactItem> {
